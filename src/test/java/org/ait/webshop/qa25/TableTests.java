...
public class TableTests {
    ...
    public void tableXpathTest() {
        ...
        System.out.println(driver.findElement(By.xpath("//td[contains(.,'Maria')]")).getText());//второй вариант написания строчки выше
    }
...
/* path - //beginning element/relationship::tagName
sibling - preceding-sibling  братская/сестринская ячейка
following-sibling
в ChroPath: //td[text()='Sweden']/preceding-sibling::td[1]
в ChroPath:  //td[text()='Ernst Handel']/following-sibling::td[1]


parent & child //с ячейки попадаю во всю строку, дети-родители
в ChroPath:  //td[text()='Sweden']/parent::tr[1]

descendant от родителя к предку(ребенку), потомок
в ChroPath:  //table[@id='customers']/descendant::td[1]

ancestor   предок
в ChroPath:  //td[text()="Sweden']/ancestor::table
